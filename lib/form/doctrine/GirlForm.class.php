 ...
 */
class GirlForm extends BaseGirlForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['img'] = new sfWidgetFormInputFileEditableProject(array(
      'file_src'  => getThumbnail($this->getObject()->getImg(),'girl',640,400),
      'is_image'  => true,
//      'edit_mode' => !$this->isNew(),
      'with_delete' => true, 
      'delete_label'=> 'Удалить фото',      
      'template'  => '<div style="padding-bottom: 5px;"><table cellspacing="0" cellspacing="0" border=0>'
      .($this->getObject()->getImg()?'<tr><td ><a href="/uploads/girl/'. $this->getObject()->getImg().'" target="_blank">
    ...
    $this->validatorSchema['img'] = new sfValidatorFile(array(
      'path' =>  sfConfig::get('app_upload_dir') . '/girl/',
